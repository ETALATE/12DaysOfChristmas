...
public class Song {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        PrintStream outputFile = new PrintStream(new File("sangtekst.txt"));
        // erstatter standardudgangen (konsollen) med outputFile, så der nu skrives til "sangtekst.txt"-filen.
        System.setOut(outputFile);

        Song song = new Song();
        System.out.println("SO THIS IS WHERE THE SONG STARTS");
        System.out.println("________________________________");
        song.printSong();
        System.out.println("________________________________");
        System.out.println("THIS IS WHERE THE SONG STOPS");
